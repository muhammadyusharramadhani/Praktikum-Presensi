...
-- Membuang data untuk tabel praktikum_presensi1.bagian: ~3 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_presensi1.bagian_karyawan: ~6 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_presensi1.jabatan: ~5 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_presensi1.jabatan_karyawan: ~17 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_presensi1.karyawan: ~8 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_presensi1.lokasi: ~3 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_presensi1.penggajian: ~18 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_presensi1.pengguna: ~8 rows (lebih kurang)
...
-- Membuang data untuk tabel praktikum_presensi1.presensi: ~562 rows (lebih kurang)
...
INSERT INTO `presensi` (`id`, `karyawan_id`, `tanggal`, `jam_masuk`, `jam_keluar`, `keterangan`) VALUES
	...
	(465, 7, '2020-12-19', NULL, NULL, 'AKHIR PEKAN'),
	(466, 7, '2020-12-20', NULL, NULL, 'AKHIR PEKAN'),
	(467, 7, '2020-12-21', '08:00:00', '16:00:00', 'HADIR'),
	(468, 7, '2020-12-22', '08:00:00', '16:00:00', 'HADIR'),
	(469, 7, '2020-12-23', '08:00:00', '16:00:00', 'HADIR'),
	(470, 7, '2020-12-24', NULL, NULL, 'LIBUR NASIONAL'),
	(471, 7, '2020-12-25', NULL, NULL, 'LIBUR NASIONAL'),
	(472, 7, '2020-12-26', NULL, NULL, 'AKHIR PEKAN'),
	(473, 7, '2020-12-27', NULL, NULL, 'AKHIR PEKAN'),
	(474, 7, '2020-12-28', '08:00:00', '16:00:00', 'HADIR'),
	(475, 7, '2020-12-29', '08:50:00', '16:00:00', 'HADIR'),
	(476, 7, '2020-12-30', '08:00:00', '16:00:00', 'HADIR'),
	(477, 7, '2020-12-31', '08:00:00', '16:00:00', 'HADIR'),
	(478, 7, '2021-01-01', NULL, NULL, 'LIBUR NASIONAL'),
	(479, 7, '2021-01-02', NULL, NULL, 'AKHIR PEKAN'),
	(480, 7, '2021-01-03', NULL, NULL, 'AKHIR PEKAN'),
	(481, 7, '2021-01-04', '08:55:00', '16:00:00', 'HADIR'),
	(482, 7, '2021-01-05', '08:00:00', '16:00:00', 'HADIR'),
	(483, 7, '2021-01-06', '08:00:00', '16:00:00', 'HADIR'),
	(484, 7, '2021-01-07', '08:00:00', '16:00:00', 'HADIR'),
	(485, 7, '2021-01-08', '08:00:00', '16:00:00', 'HADIR'),
	(486, 7, '2021-01-09', NULL, NULL, 'AKHIR PEKAN'),
	(487, 7, '2021-01-10', NULL, NULL, 'AKHIR PEKAN'),
	(488, 7, '2021-01-11', '08:00:00', '16:00:00', 'HADIR'),
	(489, 7, '2021-01-12', '08:00:00', '16:00:00', 'HADIR'),
	(490, 7, '2021-01-13', '08:00:00', '16:00:00', 'HADIR'),
	(491, 7, '2021-01-14', '08:00:00', '16:00:00', 'HADIR'),
	(492, 7, '2021-01-15', '08:00:00', '16:00:00', 'HADIR'),
	(493, 7, '2021-01-16', NULL, NULL, 'AKHIR PEKAN'),
	(494, 7, '2021-01-17', NULL, NULL, 'AKHIR PEKAN'),
	(495, 7, '2021-01-18', '08:00:00', '16:00:00', 'HADIR'),
	(496, 7, '2021-01-19', '08:00:00', '16:00:00', 'HADIR'),
	(497, 7, '2021-01-20', '08:00:00', '16:00:00', 'HADIR'),
	(498, 7, '2021-01-21', NULL, NULL, 'IZIN'),
	(499, 7, '2021-01-22', '08:00:00', '16:00:00', 'HADIR'),
	(500, 7, '2021-01-23', NULL, NULL, 'AKHIR PEKAN'),
	(501, 7, '2021-01-24', NULL, NULL, 'AKHIR PEKAN'),
	(502, 7, '2021-01-25', '08:00:00', '16:00:00', 'HADIR'),
	(503, 7, '2021-01-26', '08:00:00', '16:00:00', 'HADIR'),
	(504, 7, '2021-01-27', '08:40:00', '16:00:00', 'HADIR'),
	(505, 7, '2021-01-28', '08:00:00', '16:00:00', 'HADIR'),
	(506, 7, '2021-01-29', '08:00:00', '16:00:00', 'HADIR'),
	(507, 7, '2021-01-30', NULL, NULL, 'AKHIR PEKAN'),
	(508, 7, '2021-01-31', NULL, NULL, 'AKHIR PEKAN'),
	(509, 8, '2020-11-01', NULL, NULL, 'AKHIR PEKAN'),
	(510, 8, '2020-11-02', '08:00:00', '16:00:00', 'HADIR'),
	(511, 8, '2020-11-03', '08:00:00', '16:00:00', 'HADIR'),
	(512, 8, '2020-11-04', '08:00:00', '16:00:00', 'HADIR'),
	(513, 8, '2020-11-05', '08:00:00', '16:00:00', 'HADIR'),
	(514, 8, '2020-11-06', '08:35:00', '16:00:00', 'HADIR'),
	(515, 8, '2020-11-07', NULL, NULL, 'AKHIR PEKAN'),
	(516, 8, '2020-11-08', NULL, NULL, 'AKHIR PEKAN'),
	(517, 8, '2020-11-09', '08:00:00', '16:00:00', 'HADIR'),
	(518, 8, '2020-11-10', NULL, NULL, 'LIBUR NASIONAL'),
	(519, 8, '2020-11-11', '08:00:00', '16:00:00', 'HADIR'),
	(520, 8, '2020-11-12', '08:00:00', '16:00:00', 'HADIR'),
	(521, 8, '2020-11-13', '08:00:00', '16:00:00', 'HADIR'),
	(522, 8, '2020-11-14', NULL, NULL, 'AKHIR PEKAN'),
	(523, 8, '2020-11-15', NULL, NULL, 'AKHIR PEKAN'),
	(524, 8, '2020-11-16', '08:00:00', '16:00:00', 'HADIR'),
	(525, 8, '2020-11-17', '08:00:00', '16:00:00', 'HADIR'),
	(526, 8, '2020-11-18', '08:35:00', '16:00:00', 'HADIR'),
	(527, 8, '2020-11-19', '08:00:00', '16:00:00', 'HADIR'),
	(528, 8, '2020-11-20', '08:00:00', '16:00:00', 'HADIR'),
	(529, 8, '2020-11-21', NULL, NULL, 'AKHIR PEKAN'),
	(530, 8, '2020-11-22', NULL, NULL, 'AKHIR PEKAN'),
	(531, 8, '2020-11-23', '08:00:00', '16:00:00', 'HADIR'),
	(532, 8, '2020-11-24', '08:00:00', '16:00:00', 'HADIR'),
	(533, 8, '2020-11-25', NULL, NULL, 'IZIN'),
	(534, 8, '2020-11-26', '08:00:00', '16:00:00', 'HADIR'),
	(535, 8, '2020-11-27', '08:00:00', '16:00:00', 'HADIR'),
	(536, 8, '2020-11-28', NULL, NULL, 'AKHIR PEKAN'),
	(537, 8, '2020-11-29', NULL, NULL, 'AKHIR PEKAN'),
	(538, 8, '2020-11-30', '08:00:00', '16:00:00', 'HADIR'),
	(539, 8, '2020-12-01', '08:00:00', '16:00:00', 'HADIR'),
	(540, 8, '2020-12-02', NULL, NULL, 'CUTI'),
	(541, 8, '2020-12-03', NULL, NULL, 'CUTI'),
	(542, 8, '2020-12-04', '08:00:00', '16:00:00', 'HADIR'),
	(543, 8, '2020-12-05', NULL, NULL, 'AKHIR PEKAN'),
	(544, 8, '2020-12-06', NULL, NULL, 'AKHIR PEKAN'),
	(545, 8, '2020-12-07', '08:00:00', '16:00:00', 'HADIR'),
	(546, 8, '2020-12-08', '08:00:00', '16:00:00', 'HADIR'),
	(547, 8, '2020-12-09', NULL, NULL, 'LIBUR NASIONAL'),
	(548, 8, '2020-12-10', '08:00:00', '16:00:00', 'HADIR'),
	(549, 8, '2020-12-11', '08:00:00', '16:00:00', 'HADIR'),
	(550, 8, '2020-12-12', NULL, NULL, 'AKHIR PEKAN'),
	(551, 8, '2020-12-13', NULL, NULL, 'AKHIR PEKAN'),
	(552, 8, '2020-12-14', '08:37:00', '16:00:00', 'HADIR');
